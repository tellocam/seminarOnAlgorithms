\section{Interval Vertex Coloring (IVC) Definition}
...
\begin{frame}{Vertex Color Problem Definition}
  \begin{columns}
    ...
    \null
    \alt<1-3>{\includegraphics[width=0.8\textwidth]{figures/graph_coloring1.png}}{\includegraphics[width=0.8\textwidth]{figures/graph_coloring.png}}
    
  \end{columns}
\end{frame}

\subsection*{Interval Vertex Coloring}
